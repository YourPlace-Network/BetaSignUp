...
// Extending global window object to include hcaptcha callback function - https://stackoverflow.com/questions/56457935/typescript-error-property-x-does-not-exist-on-type-window
declare global {
    interface Window {
        captchaSubmit: any;
    }
